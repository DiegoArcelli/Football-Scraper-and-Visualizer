...
def compare_shot(shot_1, shot_2):
    x1_1, y1_1, x2_1, y2_1, info1 = shot_1
    player_1 = info1["player"]
    minute_1 = info1["minute"]
    team_1 = info1["team"]
    outcome_1 = info1["outcome"]

    x1_2, y1_2, x2_2, y2_2, info2 = shot_2
    player_2 = info2["player"]
    minute_2 = info2["minute"]
    team_2 = info2["team"]
    outcome_2 = info2["outcome"]

    if (x1_1, y1_1, x2_1, y2_1, player_1, minute_1, team_1) == (x1_2, y1_2, x2_2, y2_2, player_2, minute_2, team_2) and outcome_1 != outcome_2:
        return True
...
with open("parse_map/shots", "r") as f:
    text = f.read()
